...
namespace Zork
{
    internal class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            roomMap["Rocky Trail"].Description = "You are in a rock-strewn trail.";
            ...
            roomMap["Dense Woods"].Description = "This is a dimly lit forest, with large trees all around. To the east, there appears to be sunglight.";
